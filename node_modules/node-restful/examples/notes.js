...
User.route("notes", {
  handler: function(req, res, next, err, model) { // we get err and model parameters on detail controllers (model being the one model that was found)
  ...
  detail: true, // detail controllers operate on a single instance, i.e. /user/:id
